...
import {filmsModel, profile} from './data.js';
...
const naviComponent = new NavigationComponent();
...
const pageController = new PageController(container, sortComponent, naviComponent, filmsModel.getFilmsAll());
